    ...
    <ul class="navbar-nav">
      <li class="logo">
        <nuxt-link to="/" class="nav-link">
          <span class="link-text logo-text">Andrew</span>
      ...
      <li class="nav-item">
        ...
        <div class="contact-container">
          <ul class="icons">
            <li><a href="https://github.com/ABStein" class="fab fa-github-alt"></a></li>
            <li><a href="https://medium.com/@ABStein" class="fab fa-medium"></a></li>
            <li><a href="https://www.linkedin.com/in/andrew-stein-755b8b11a" class="fab fa-linkedin"></a></li>
          </ul>
        </div>
      </li>
    </ul>
